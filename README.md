...
A type-safe API example built with [tRPC](https://trpc.io/) — a framework for building end-to-end typesafe APIs in TypeScript without code generation or schemas.
...
```bash
git clone https://github.com/GetWebstack-public/nodejs-trpc
cd nodejs-trpc
```
